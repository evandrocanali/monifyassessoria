...
const LanguageSelector = ({ isMobile = false }) => {
  ...
  return (
    <div className={`relative z-50 ${isMobile ? 'w-full flex flex-col items-center' : ''}`}>
      <button
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className={`mt-2 w-40 bg-brand-charcoal border border-white/10 rounded-xl shadow-2xl z-50 py-2 overflow-hidden ${
                isMobile ? 'relative mx-auto' : 'absolute right-0'
              }`}
            >
              {languages.map((lang) => (
                <button
