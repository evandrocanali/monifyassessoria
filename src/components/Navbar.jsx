      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <img src="/logo-premium.png" alt="Monify Logo" className="h-10 w-auto mr-3" />
            <span className="text-2xl font-cinzel font-bold text-gradient-gold tracking-widest">MONIFY</span>
          </div>
