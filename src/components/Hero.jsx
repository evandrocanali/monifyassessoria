...
const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      {/* Full background house image — centered */}
      <div
        className="absolute inset-0"
        style={{
          backgroundImage: 'url(/hero-mansion.png)',
      ...
      {/* Gold gradient from top */}
      <div className="absolute inset-0 bg-gradient-to-b from-brand-gold/5 via-transparent to-[#0A0A0A]/60" />

      {/* Gold glow accents */}
      <div className="absolute -top-24 right-1/4 w-96 h-96 bg-brand-gold/10 rounded-full blur-[120px]" />
      <div className="absolute -bottom-24 left-1/4 w-96 h-96 bg-brand-gold/5 rounded-full blur-[120px]" />
